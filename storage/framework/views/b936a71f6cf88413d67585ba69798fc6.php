...
<div id="content">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="h4 mb-0 text-gradient-primary">Kalayaan Branch Library</h4>
        </div>
...
<?php echo $__env->make('layouts.librarian', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\library\resources\views/librarian/kalayaan/dashboard.blade.php ENDPATH**/ ?>