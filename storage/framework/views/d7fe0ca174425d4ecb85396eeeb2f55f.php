            ...
            <div class="page-one legal bg-white">
                ...
                <table class="table table-borderless mt-2"> 
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $totalcash; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cash): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($cash->payment_status == 'Paid'): ?>  
                                <tr>
                                    <td><?php echo e($index + 1); ?></td>
                                    <td><?php echo e(!empty($cash->student) ? $cash->student->lname : 'N/A'); ?>, <?php echo e(!empty($cash->student) ? $cash->student->fname : 'N/A'); ?></td>
                                    <td><?php echo e(number_format($cash->penalty, 2)); ?></td>
                                    <td><?php echo e(number_format($cash->total_payable, 2)); ?></td>  
                                </tr>
                                <?php $totalPayment += $cash->total_payable; ?> <!-- Accumulate the total -->
                            <?php endif; ?>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="3" class="text-right"><strong>Total Cash on Hand:</strong></td>
...
</html><?php /**PATH F:\laragon\www\library\resources\views/pdf/totalcash.blade.php ENDPATH**/ ?>