                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?php echo e(route('qr.index')); ?>" class="d-none d-sm-inline-block btn btn-sm bg-gradient-primary shadow-sm"><i
                                class="fa fa-qrcode fa-sm text-white-50"></i> Add Entry</a>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <span class="text-info font-weight-bold blinking"><?php echo e(\Carbon\Carbon::now()->format('F d, Y')); ?></span>
...
<?php echo $__env->make('layouts.librarian', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\library\resources\views/students/student_logins.blade.php ENDPATH**/ ?>