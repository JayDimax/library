        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon rotate-n-15">
                    <img src="<?php echo e(Storage::url('hccd.png')); ?>" alt="" width="75" height="auto">
                </div>
                <div class="sidebar-brand-text mx-3">Library<sup>System</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <span>Library Section</span></span>
                </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Borrowers:</h6>
                        <a class="collapse-item" href="#">Borrowers List</a>
                        <a class="collapse-item" href="#">Add New</a>
                        <a class="collapse-item" href="#">Update</a>
                    </div>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Students Record:</h6>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <p class="text-center mb-2"><strong>Buy me a Coffee!</strong> Gcash# 0936 272 1861</p>
            </div>
...
</html><?php /**PATH D:\laragon\www\library\resources\views/layouts/admin.blade.php ENDPATH**/ ?>