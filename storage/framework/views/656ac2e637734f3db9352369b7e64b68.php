            ...
            <div class="tab-pane fade" id="attendance" role="tabpanel">
                <div class="accordion" id="attendanceAccordion">
                    ...
                    <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="card mb-2">
                            <div class="card-header p-2" id="heading<?php echo e($index); ?>">
                                <h6 class="mb-0">
                                    <button class="btn btn-link text-dark font-weight-bold" type="button" data-toggle="collapse" data-target="#collapse<?php echo e($index); ?>">
                                        <?php echo e($stat['label']); ?>

                                    </button>
                                </h6>
                            </div>
                            <div id="collapse<?php echo e($index); ?>" class="collapse <?php echo e($index === 0 ? 'show' : ''); ?>" data-parent="#attendanceAccordion">
                                <div class="card-body text-center">
                                    <span class="h6 text-primary font-weight-bold"><?php echo e($stat['value']); ?></span>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.librarian', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\library\resources\views/librarian/kalayaan/dashboard.blade.php ENDPATH**/ ?>